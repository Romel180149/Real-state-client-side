...
const DetailsPageReview = ({ propertyID }) => {
    const [allReviews, refetch] = useReviews()
    const matchedReviews = allReviews.filter(review => review.propertyID === propertyID)
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8">
                        {
                            matchedReviews.map(review => (
                                <blockquote key={review._id} className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                                    <div className="flex items-center gap-4">
                                        <img
                                            alt="Man"
                                            src={review.Reviewer_img?.toString()}
